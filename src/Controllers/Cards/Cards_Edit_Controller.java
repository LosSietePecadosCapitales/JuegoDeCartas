...
public class Cards_Edit_Controller {
    ...
    private void init_starts(String auxString){
    ...
    private void initializeCardInfo(){
        Cards c = Cards_Main_Controller.selectCard;
        
        name_Card_Label.setText(c.getName());
        name_Card_TF.setText(c.getName());
        
        stars_Amounts_S.setValue(String.valueOf(c.getStars()));
        init_starts(String.valueOf(c.getStars()));
        
        element_Card_CB.setValue(c.getElement());
        init_element(c.getElement());
        
        type_Card_TF.setValue(c.getType());
        type_Card_Label.setText("[ "+c.getType()+" ]");
        
        description_Card_TA.setText(c.getDescription());
        description_Card_Label.setText(c.getDescription());
        
        atk_Card_Label.setText(String.valueOf(c.getAtk()));
        atk_Card_TF.setText(String.valueOf(c.getAtk()));
        
        def_Card_Label.setText(String.valueOf(c.getDef()));
        def_Card_TF.setText(String.valueOf(c.getDef()));
        
        BufferedImage bi = SwingFXUtils.fromFXImage(c.getImagen(), null).getSubimage(46, 102, 290, 290);
        image_Card.setImage(SwingFXUtils.toFXImage(bi, null));
