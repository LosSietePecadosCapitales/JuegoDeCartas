...
import static Controllers.Decks.Decks_Create_Controller.selectCard;
...
//            Decks_Create_Controller.this.amount_Label.setText((Decks_Create_Controller.this.count++)+"/40");
    ...
    public void initializeSelectedDeck(){
        // INICIALIZAR EL DECK SELECCIONADO EN DECKS_MAIN_CONTROLLER Y
        // MOSTRAR LAS CARTAS EN EL SCROLLPANE (DENTRO HAY UN HBOX)
    }
}
